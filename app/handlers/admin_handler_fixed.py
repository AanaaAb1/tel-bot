...
# Enhanced approve payment - FIXED VERSION without markdown
async def admin_approve_payment(update, context):
    ...
    try:
        ...
        if payment:
            ...
            # Enhanced notification to user - FIXED without markdown
            if user:
                try:
                    # Send celebration message without markdown
                ...
                await context.bot.send_message(
                    chat_id=update.effective_user.id,
                    text=f"❌ Payment approved but user not found\n"
                         f"Payment ID: {payment_id}\n"
                         f"Please check the user database."
                )
        else:
            await safe_edit_message_text(update, 
...
# Enhanced reject payment - FIXED VERSION without markdown
