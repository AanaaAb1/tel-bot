#!/usr/bin/env python3
"""
Comprehensive Test for Answer Processing System
...
class TestAnswerProcessingSystem:
    def __init__(self):
        self.engine = None
    ...
    def test_question_keyboard_creation(self):
        """Test keyboard creation for questions"""
        print("\n🎛️ Testing Question Keyboard Creation...")
        ...
        if not hasattr(keyboard, 'inline_keyboard'):
            print("❌ Keyboard does not have inline_keyboard attribute!")
            return False
            
        if len(keyboard.inline_keyboard) != len(question_data['options']):
            print(f"❌ Keyboard has {len(keyboard.inline_keyboard)} buttons, expected {len(question_data['options'])}")
            return False
            
        print(f"✅ Keyboard created successfully:")
        print(f"   - {len(keyboard.inline_keyboard)} buttons")
        print(f"   - All options have callback data")
    ...
    def run_all_tests(self):
        ...
        print("🚀 Starting Answer Processing System Tests")
        print("=" * 60)
        ...
        try:
            ...
            tests = [
                ...
                ("Question Keyboard Creation", self.test_question_keyboard_creation),
            ...
            if passed_tests == total_tests:
                print("\n🎉 ALL TESTS PASSED! Answer Processing System is working correctly!")
                print("\n📋 Verified Features:")
                print("✅ Question data creation with difficulty filtering")
                print("✅ Question keyboard generation")
...
if __name__ == "__main__":
    tester = TestAnswerProcessingSystem()
